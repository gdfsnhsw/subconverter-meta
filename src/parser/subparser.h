...
void hysteriaConstruct(Proxy &node, const std::string &group, const std::string &remarks, const std::string &add, const std::string &port, const std::string &type, const std::string &protocol, const std::string &auth, const std::string &host, const std::string &upmbps, const std::string &downmbps, const std::string &alpn, const std::string &obfs, const std::string &obfsparam, const std::string &iscv, tribool udp = tribool(), tribool tfo = tribool(), tribool scv = tribool(), tribool tls13 = tribool());
